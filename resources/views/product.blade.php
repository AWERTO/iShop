				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="flex-sb-m flex-w p-b-35">
						<div class="flex-w">
							...
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								{!! Form::open(['url' => '/product-price']) !!}
								{!! Form::select('price' , [  '00.00$-50$' => '00.00$-50$',
															  '50$-100$' => '50$-100$',
															  '100$-150$' => '100$-150$',
															  '150$-200$' => '150$-200$',
															  '$200+' => '$200+'], '00.00$-50$' , ['class' => 'selection-2']) !!}
								{!! Form::button('Price',  ['type' => 'submit' ]) !!}
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product-detail?id={{$product->name}}" class="block2-name dis-block s-text3 p-b-5">
										{{$product->name}}
									</a>
									@if($product->status == 'sale')
