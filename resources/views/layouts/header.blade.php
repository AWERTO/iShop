<header class="header1">
    ...
    <div class="container-menu-header">
        ...
        <div class="wrap_header">
            <!-- Logo -->
            <a href="/" class="logo">
                <img src="{{'images/icons/iShopLogo_Web.png'}}"  alt="IMG-LOGO">
            </a>
            ...
            <div class="header-icons">
                ...
                <div class="header-wrapicon2">
                    ...
                    @if (isset($wishlist))
                    <span class="header-icons-noti">{{count($wishlist)}}</span>
                    @else
                    ...
                    <div class="header-cart header-dropdown">
                        <ul class="header-cart-wrapitem">
                            @if(isset($wishlist))
                                <?php  $array= array_count_values($wishlist);?>
                                <?php  $a= ksort($array);?>
                            ...
                            <li class="header-cart-item">
                                ...
                                <div class="header-cart-item-txt">
                                    <a href="/product-detail?id={{$product->products_id}}" class="header-cart-item-name">
                                        {{$product->name}}
                                    </a>
                        ...
                        <div class="header-cart-buttons">
                            ...
                            <div class="header-cart-wrapbtn">
                                ...
                                <a href="/reset-cart" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
                                    Reset sale
                                </a>
                            </div>
                        </div>
    ...
    <div class="wrap_header_mobile">
        ...
        <div class="btn-show-menu">
            ...
            <div class="header-icons-mobile">
                ...
                <div class="header-wrapicon2">
                    <img src="{{'images/icons/icon-header-02.pn'}}g" class="header-icon1 js-show-header-dropdown" alt="ICON">
                    <span class="header-icons-noti">0</span>
